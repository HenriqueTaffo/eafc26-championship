-- v108 - Fix unassigned trade record in external transfer signature flow.
--
-- When a proposal has no player swap, PL/pgSQL record v_trade stayed unassigned
-- and later field access could raise "record v_trade is not assigned yet".
